    ...
    <div className="min-h-screen bg-[#F6F8FC] text-slate-900">
      <header className="h-14 border-b border-slate-200 bg-white flex items-center justify-between px-5">
        <div className="flex items-center gap-3">
          ...
          <div className="hidden md:flex items-center gap-2 rounded-xl border border-slate-200 bg-slate-50 px-3 h-9 text-sm text-slate-500">
            Search
          </div>
        </div>
        ...
        <div className="flex items-center gap-3">
          <button
            type="button"
            className="hidden sm:inline-flex h-9 rounded-xl border border-slate-200 bg-white px-3 text-sm font-semibold text-slate-700 hover:bg-slate-50 transition"
          >
            Support
          </button>
          <div className="h-9 w-9 rounded-xl bg-indigo-600 text-white grid place-items-center text-sm font-semibold">
            {avatar}
          </div>
        </div>
      </header>
      ...
      <div className="flex">
        <aside className="hidden lg:block w-[260px] border-r border-slate-200 bg-white min-h-[calc(100vh-56px)]">
          <div className="px-4 py-4 text-xs font-semibold text-slate-500 uppercase tracking-[0.18em]">
            Home
          </div>
          ...
          <div className="mt-6 px-4 py-4 text-xs font-semibold text-slate-500 uppercase tracking-[0.18em]">
            Account
          </div>
          <nav className="px-2 space-y-1 text-sm">
            {["My account", "Admin", "Support"].map((label) => (
              <a
                key={label}
                href="#"
                className="flex items-center gap-2 rounded-xl px-3 py-2 text-slate-700 hover:bg-slate-50 transition"
              >
          ...
          <div className="mx-auto max-w-6xl grid gap-6 lg:grid-cols-[1.6fr_0.9fr]">
            <section className="space-y-6">
              <div className="rounded-3xl border border-slate-200 bg-white shadow-sm p-6 flex items-center gap-4">
                <div className="h-16 w-16 rounded-2xl bg-indigo-600 text-white grid place-items-center text-2xl font-semibold">
                  {avatar}
                </div>
                <div className="min-w-0">
                  <div className="text-lg font-semibold text-slate-900 truncate">{displayName}</div>
                  <div className="mt-1 text-sm text-slate-500">Workspace Basic</div>
                </div>
                <div className="ml-auto">
                  <button
                    type="button"
                    className="h-10 rounded-xl border border-slate-200 bg-white px-4 text-sm font-semibold text-slate-700 hover:bg-slate-50 transition"
                  >
                    Manage plan
                  </button>
                </div>
              ...
              <div className="rounded-3xl border border-slate-200 bg-white shadow-sm p-6">
                ...
                <div className="mt-4 flex flex-col sm:flex-row gap-3">
                  <input
                    ...
                    className="h-11 flex-1 rounded-2xl border border-slate-200 bg-white px-4 text-sm outline-none focus:border-slate-300"
                  />
                  <button
                    type="button"
                    onClick={() => {
                      const room = roomName.trim() || "draftmin-product-review";
                ...
                <div className="mt-3 text-xs text-slate-500">
                  Use any room name to start a shared meeting space.
                </div>
              </div>
              ...
              <div className="rounded-3xl border border-slate-200 bg-white shadow-sm p-6">
                ...
                <div className="mt-6 rounded-3xl border border-dashed border-slate-200 bg-slate-50 p-10 text-center">
                  ...
                  <div className="mt-2 text-sm text-slate-500">
                    Your meetings and recordings will show up here.
                  </div>
                </div>
              </div>
            </section>
            ...
            <aside className="space-y-6">
              <div className="grid grid-cols-3 gap-3">
                {[
                  ...
                  <button
                    ...
                    type="button"
                    onClick={item.action}
                    className="rounded-3xl border border-slate-200 bg-white shadow-sm p-4 hover:bg-slate-50 transition text-center"
                  >
                    <div className="mx-auto h-12 w-12 rounded-2xl bg-blue-600 text-white grid place-items-center text-sm font-semibold">
              ...
              <div className="rounded-3xl border border-slate-200 bg-white shadow-sm p-6">
                ...
                <div className="mt-4 rounded-2xl bg-slate-50 border border-slate-200 p-4">
                  ...
                  <button
                    type="button"
                    className="mt-3 h-10 rounded-xl border border-slate-200 bg-white px-4 text-sm font-semibold text-slate-700 hover:bg-slate-50 transition"
                  >
